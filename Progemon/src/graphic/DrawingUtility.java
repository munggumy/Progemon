...
public class DrawingUtility {
	...
	public static void drawPokemon(Pokemon pokemon) {
		...
		try {
			ScreenComponent.g2.drawImage(img, null, pokemon.getCurrentFightTerrain().getX() * 40,
					pokemon.getCurrentFightTerrain().getY() * 40);
		} catch (Exception e) {
			e.printStackTrace();
			System.err.println(pokemon.getName()); // this is not null
			System.err.println(pokemon.getCurrentFightTerrain()); // this is null
		}
	}
